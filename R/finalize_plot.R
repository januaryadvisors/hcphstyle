...
#'
#' Running this function will save your plot with the correct guidelines for publication for a HCPH graphic.
#' It will left align your title, subtitle and source, add the HCPH logo at the bottom right and save it to your specified location.
...
finalise_plot <- function(plot_name,
                          ...
                          width_pixels=640,
                          height_pixels=450,
                          logo_image_path = file.path(system.file("data", package = 'hcphstyle'),"hcph_logo_unofficial.png")) {
